...
.. image:: google_search_console/add-domain-or-url-prefix.webp
...
#. In your Odoo database, go to :menuselection:`Website --> Configuration --> Settings`,
   ...
   .. image:: google_search_console/paste-html-code-settings.webp
